			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="" style="border-left: 3px double #ffc107; padding: 0 2%;">
                        <h1 class="mt-5 mb-4" style="letter-spacing: 2px; color:#023021; font-size: 25px; font-weight:600;">Create User Account</h1>
                    </div>
								...
								<div class="col-lg-6">
									...
									<div class="mb-3">
										<div class="d-grid gap-2">
											<input type="submit" name="addUser" class="btn btn-dark px-5 quBtn" value="Submit">
										</div>											
									</div>

									<div class="d-flex justify-content-between">
										<div class="form-group">
						                	<i class="fa-regular fa-circle-question"></i> Already has an Account? <a href="login.php">Login Here</a>
						                </div>
						                <div class="form-group">
						                	<i class="fa-regular fa-circle-question"></i> Create Seller Account? <a href="sellerregister.php">Signup Here</a>
						                </div>
									</div>
						...
						<?php  
							if ( isset($_POST['addUser']) ) {
								...
								if ( $password == $repassword ) {
									...
									$addRole = "INSERT INTO role ( name, email, phone, address, password, role, image, status, join_date ) VALUES ( '$name', '$email', '$phone', '$address', '$hassedPass', '$role', '$img', '$status', now() )";
