        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-uppercase d-flex justify-content-between">
                    <div>
                        <h4 class="renthead" style="color: #023021; font-size: 25px;">EXPLORE Buy CATEGORY</h4>
                    </div>
                    <div class="d-flex">
                        ...
                        <h4 class="shorttext" style="color:#6c757d; font-size: 17px; font-weight: 400; ">Buy CATEGORY</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 d-flex justify-content-center text-uppercase">
                    <?php  
                        ...
                        while ( $row = mysqli_fetch_assoc( $rentcategoryQuery ) ) {
                            ...
                            ?>
                                <a href="buy_products.php?pid=<?php echo $id; ?>"><p class="border border-dark-subtle p-3 me-4 category_name" style="color: #023021; font-size: 19px; letter-spacing: 0.9px; font-weight: 600;"><?php echo $name; ?></p></a>
                            <?php
                        }
    ...
    <!-- START: RESULT TOTAL -->
     <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <?php  
                    $sql = "SELECT * FROM buy_subcategory WHERE status = 1";
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($rentcategoryQuery)) {
                            ...
                            <div style="border-left: 3px double #ffc107; padding: 0 2%;">
                                <h1 class=""  style="letter-spacing: 3px; color:#023021; font-size: 30px; font-weight:600; text-transform: uppercase;"><?php echo $catname; ?></h1>
                            </div>
