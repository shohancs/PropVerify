...
<main>
        ...
        <div class="container pt-3">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row pt-4">
                        <div class="col-lg-12">
                            <div class="d-flex justify-content-center fr-service">
                                <a href="rent.php">
                                    <div class="card me-5 py-3 service-card seCard" style="width: 18rem;">
                                        <div class="card-body">                                        
                ...
                <div class="col-lg-12">
                    <div class="d-flex align-items-center justify-content-between">
                        <div style="border-left: 3px double #ffc107; padding: 0 2%;">
                            ...
                            <h1 class="bigFormate"  style="letter-spacing: 3px;  color:#023021; font-size: 40px; font-weight:600;">Explore Rent Category</h1>
                        </div>
                        <div>
                    ...
                    <div class="py-5">
                        ...
                        <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" free-mode="true" slides-per-view="1" space-between="30" breakpoints='{"576":{"slidesPerView":1},"768":{"slidesPerView":2},"992":{"slidesPerView":3}}'>
                                                                                                                ...
                                                                                                                <div class="row">
                                                                                                                    <div class="col-lg-10">
                                                                                                                        <div>
                                                                                                                            ...
                                                                                                                            <h4 class="fw-semibold" style="color:#023021; letter-spacing: 0.7px;">৳<?php echo number_format($price) ; ?> BDT <sup class="fw-medium">PER 
                                                                                                                                <?php 
                                                                                                                                    if ( $cat_id == 2 ) {
                                                                                                                                        echo "NIGHT";
                                                                                                                                    }
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <div class="d-flex align-items-center justify-content-between">
                                                                                <div style="border-left: 3px double #ffc107; padding: 0 2%;">
                                                                                    <p style="margin: 0; color:#023021;">Browse Hot Offer</p>
                                                                                    <h1 class="bigFormate"  style="letter-spacing: 3px;  color:#023021; font-size: 40px; font-weight:600;">Explore Buy Category</h1>
                                                                                </div>
                                                                                <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-10">
                                                            <div>
                                                                ...
                                                                <h5 class="fw-semibold py-2" style="text-align:justify; color:#023021; letter-spacing: 0.5px;"><?php echo $subcat_name; ?></h5>  
                                                                <h4 class="fw-semibold" style="color:#023021; letter-spacing: 0.7px;">৳<?php echo number_format($price) ; ?> BDT</h4>
    ...
    <!-- START: CONTACT -->
     <div class="text-bg-light pb-5 pt-3" >
        <section class="p-5 contact-back" style="background: #1a7e00; color: #fff; width: 60%; margin: 0px auto; border-radius: 10px;">
        <div class="d-flex justify-content-evenly align-items-center contact-devide">
            <div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8 question_part">
                    <div class="bg-white questionForm">
