        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-uppercase d-flex justify-content-between">
                    <div>
                        <h4 class="renthead" style="color: #023021; font-size: 25px;">Hotel Booking Information</h4>
                    </div>
                    <div class="d-flex">
                        ...
                        <h4 class="shorttext" style="color:#6c757d; font-size: 17px; font-weight: 400; ">booking</h4>
                    </div>
                </div>
            </div>
        </div>
