                        ...
                        <div class="col-lg-12 text-uppercase d-flex justify-content-between">
                            <?php  
                                    ...
                                    while ($row = mysqli_fetch_assoc($query)) {
                                        ...
                                        ?>
                            <div>
                                <h4 class="renthead" style="color: #023021; font-size: 25px;">Rent Details <?php echo $cat_name; ?> </h4>
                            </div>
                            <div class="d-flex">
                                ...
                                <h4 class="px-2 shorttext" style="color:#545454; font-size: 17px; font-weight: 400; "> / </h4>
                                        ...
                                        <a href="products.php?pid=<?php echo $cat_id; ?>"><h4 class="shorttext" style="color:#545454; font-size: 17px; font-weight: 400; "><?php echo $cat_name; ?></h4></a>
                                        <?php
                                        }
                                ...
                                <h4 class="px-2 shorttext" style="color:#545454; font-size: 17px; font-weight: 400; "> / </h4>
                                <h4 class="shorttext" style="color:#6c757d; font-size: 17px; font-weight: 400; "><?php echo $slug; ?></h4>
                            </div>
                        </div>
                ...
                <!-- START: Product DETAILS IMAGE -->
                 ...
                 <div class="container">
                    <div class="mySlides">
                        ...
                        <?php
                            if (!empty($img_one)) {
                                echo '<img src="admin/assets/images/subcategory/' . $img_one . '" alt="" class="sliderImges">';
                            } else {
                    ...
                    <div class="mySlides">
                        ...
                        <?php
                            if (!empty($img_two)) {
                                echo '<img src="admin/assets/images/subcategory/' . $img_two . '" alt="" class="sliderImges">';
                            } else {
                                echo '<img src="admin/assets/images/dummy.jpg" alt="" class="sliderImges">';
                            }
                        ?>
                    ...
                    <div class="mySlides">
                        ...
                        <?php
                            if (!empty($img_three)) {
                                echo '<img src="admin/assets/images/subcategory/' . $img_three . '" alt="" class="sliderImges">';
                            } else {
                                echo '<img src="admin/assets/images/dummy.jpg" alt="" class="sliderImges">';
                            }
                        ?>
                    ...
                    <div class="mySlides">
                        ...
                        <?php
                            if (!empty($img_four)) {
                                echo '<img src="admin/assets/images/subcategory/' . $img_four . '" alt="" class="sliderImges">';
                            } else {
                                echo '<img src="admin/assets/images/dummy.jpg" alt="" class="sliderImges">';
                            }
                        ?>
                    ...
                    <div class="mySlides">
                        ...
                        <?php
                            if (!empty($img_five)) {
                                echo '<img src="admin/assets/images/subcategory/' . $img_five . '" alt="" class="sliderImges">';
                            } else {
                                echo '<img src="admin/assets/images/dummy.jpg" alt="" class="sliderImges">';
                            }
                        ?>
                    ...
                    <div class="mySlides">
                        ...
                        <?php
                            if (!empty($img_six)) {
                                echo '<img src="admin/assets/images/subcategory/' . $img_six . '" alt="" class="sliderImges">';
                            } else {
                                echo '<img src="admin/assets/images/dummy.jpg" alt="" class="sliderImges">';
                            }
                        ?>
