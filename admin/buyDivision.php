			...
			<div class="page-content">
				...
				<?php  
					...
					if ( $do == "Manage" ) { ?>
							...
							<div class="ms-auto">
								<div class="btn-group">
									<div class="row row-cols-auto g-3">
										<div class="col">
											<a href="buyDivision.php?do=Add" class="btn btn-dark px-5">Add New Division</a>
										</div>
										<div class="col">
											<a href="buyDivision.php?do=ManageTrash" class="btn btn-danger px-5">Trash</a>
										</div>									
									</div>
								</div>
							</div>
						...
						<h6 class="mb-0 text-uppercase">ALL Buy DIVISION LIST</h6>
						<hr>
						<div class="card">
							<div class="card-body">
										...
										<table class="table table-striped table-hover table-bordered"  id="example">
										  ...
										  <tbody>
										  	<?php  
										  		...
										  		$rentDivSql = "SELECT * FROM buy_division WHERE status = 1 ORDER BY priority ASC";
										  				...
										  				?>
														      ...
														      <td class="text-center">
														      	<div class="action-btn">
														      		<ul>
														      			<li>
														      				<a href="buyDivision.php?do=Edit&editId=<?php echo $id; ?>" class="btn btn-outline-primary" style="margin: 0 15px;"><i class="fa-solid fa-pencil"></i> Edit</a> 
																  ...
																  <div class="modal-dialog">
																    <div class="modal-content">
																      ...
																      <div class="modal-footer justify-content-around">
																      	<ul>
																      		<li>
																      			<a href="buyDivision.php?do=Trash&tData=<?php echo $id; ?>" class="btn btn-primary">Yes</a>
					...
					<?php }
						...
						<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
							...
							<div class="ps-3">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 p-0">
										...
										<li class="breadcrumb-item active" aria-current="page">Add New Buy Division</li>
									</ol>
								</nav>
							</div>
							<!-- START: For Right Part -->
							<div class="ms-auto">
								<div class="btn-group">
									<div class="row row-cols-auto g-3">
										<div class="col">
											<a href="buyDivision.php?do=Manage" class="btn btn-dark px-5">Add New Buy Division</a>
										</div>
										<div class="col">
											<a href="buyDivision.php?do=ManageTrash" class="btn btn-danger px-5">Trash</a>
										</div>									
						...
						<h6 class="mb-0 text-uppercase">Add New Buy Division</h6>
						<hr>
						<div class="card" style="width: 45%;">
							<div class="card-body">
								<div class="border p-3 radius-10">
									<!-- START : FORM -->
									<form action="buyDivision.php?do=Store" method="POST" enctype="multipart/form-data">
					...
					<?php }
						...
						if ( isset($_POST['addDiv']) ) {
							...
							$addRentDivSql = "INSERT INTO buy_division ( name, priority, status, join_date ) VALUES ( '$name', '$priority', '$status', now() )";
							$addRentDivQuery = mysqli_query ( $db, $addRentDivSql );

							if ( $addRentDivQuery ) {
							  	header( "Location: buyDivision.php?do=Manage" );
							}  
							else {
						...
						if ( isset($_GET['editId']) ) {
							...
							$editSql = "SELECT * FROM buy_division WHERE id='$editIdStore'";
							...
							while ( $row = mysqli_fetch_assoc( $editQuery ) ) {
								...
								<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
									...
									<div class="ps-3">
										<nav aria-label="breadcrumb">
											<ol class="breadcrumb mb-0 p-0">
												...
												<li class="breadcrumb-item active" aria-current="page">Buy Division Edit</li>
											</ol>
										</nav>
									</div>
									<!-- START: For Right Part -->
									<div class="ms-auto">
										<div class="btn-group">
											<div class="row row-cols-auto g-3">
												<div class="col">
													<a href="buyDivision.php?do=Manage" class="btn btn-dark px-5">All Rent Division</a>
												</div>
												<div class="col">
													<a href="buyDivision.php?do=Add" class="btn btn-primary px-5">Add New Rent Division</a>
												</div>
												<div class="col">
													<a href="buyDivision.php?do=ManageTrash" class="btn btn-danger px-5">Trash</a>
												</div>									
								...
								<h6 class="mb-0 text-uppercase">Edit Buy Division Info</h6>
								<hr>
								<div class="card" style="width: 45%;">
									<div class="card-body">
										<div class="border p-3 radius-10">
											<!-- START : FORM -->
											<form action="buyDivision.php?do=Update" method="POST" enctype="multipart/form-data">
												<div class="mb-3">
													<label>Division Name</label>
						...
						if (isset( $_POST['updateRentCat'] )) {
							...
							$updateRentSql = "UPDATE buy_division SET name='$name', priority='$priority', status='$status', join_date=now() WHERE id='$updateId'";
						...
						if (isset($_GET['tData'])) {
							$trashId = $_GET['tData'];
							$trashSql = "UPDATE buy_division SET status=0 WHERE id='$trashId'";
						...
						<!--breadcrumb-->
						<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
							<div class="breadcrumb-title pe-3">Manage Buy Division Trash</div>
							<div class="ps-3">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 p-0">
										<li class="breadcrumb-item"><a href="dashboard.php"><i class="bx bx-home-alt"></i></a>
										</li>
										<li class="breadcrumb-item active" aria-current="page">Trash Buy Division list</li>
									</ol>
								</nav>
							</div>
							<!-- START: For Right Part -->
							<div class="ms-auto">
								<div class="btn-group">
									<div class="row row-cols-auto g-3">
										<div class="col">
											<a href="buyDivision.php?do=Manage" class="btn btn-primary px-5">All Buy Division</a>
										</div>
										<div class="col">
											<a href="buyDivision.php?do=Add" class="btn btn-dark px-5">Add New Buy Category</a>
										</div>									
									</div>
								</div>
							</div>
						...
						<h6 class="mb-0 text-uppercase">TRASH Buy Division LIST</h6>
						<hr>
						<div class="card">
							<div class="card-body">
								<div class="border p-3 radius-10">
										...
										<table class="table table-striped table-hover table-bordered"  id="example">
										  ...
										  <tbody>
										  	<?php  
										  		...
										  		$categoryRentSql = "SELECT * FROM buy_division WHERE status = 0 ORDER BY priority ASC";
										  				...
										  				?>
														      ...
														      <td class="text-center">
														      	<div class="action-btn">
														      		<ul>
														      			<li>
														      				<a href="buyDivision.php?do=Edit&editId=<?php echo $id; ?>" class="btn btn-outline-primary"><i class="fa-solid fa-pencil"></i> Edit</a> 
														      				<a href="buyDivision.php?do=ManageActive&activeId=<?php echo $id; ?>" class="btn btn-outline-success" style="margin: 0 15px;"><i class="fa-solid fa-file-circle-check"></i> Active</a> 
																  ...
																  <div class="modal-dialog">
																    <div class="modal-content">
																      ...
																      <div class="modal-footer justify-content-around">
																      	<ul>
																      		<li>
																      			<a href="buyDivision.php?do=Delete&dData=<?php echo $id; ?>" class="btn btn-primary">Yes</a>
																      			<a href="" class="btn btn-dark" data-bs-dismiss="modal">No</a>
																      		</li>
																      	</ul>
																      </div>
					...
					<?php }
						...
						if ( isset($_GET['activeId']) ) {
							$acId = $_GET['activeId'];
							$activeSql = "UPDATE buy_division SET status=1 WHERE id='$acId'";
						...
						if (isset($_GET['dData'])) {
							...
							$deleteSQL = "DELETE FROM buy_division WHERE id='$deleteData' ";
							$deleteQuery = mysqli_query($db, $deleteSQL);

							if ($deleteQuery) {
								header("Location: buyDivision.php?do=ManageTrash");
							}
							else {
								die("Mysqli_Error" . mysqli_error($db));
							}
